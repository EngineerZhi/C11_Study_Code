...
public:
	...
	virtual std::shared_ptr<TrafficTyre> TyreCreate(std::shared_ptr<Traffic> traffic) = 0;
};
//汽车工厂
class CarFactory : public Factory {
public:
	std::shared_ptr<Traffic>     TrafficCreate() { return std::make_shared<CarTraffic>(); }
	std::shared_ptr<TrafficTyre> TyreCreate(std::shared_ptr<Traffic> traffic) { 
		return std::make_shared<CarTyre>(); }
};
//===================================================================//
